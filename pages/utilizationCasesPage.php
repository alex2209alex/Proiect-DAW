...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <p>Un spital in general presteaza urmatoarele servicii catre pacienti: consultatii de specialitate,
                recoltare probe si efectuare analize laborator, etc.</p>
            ...
            <ol>
                <li>
                    ...
                    <ul>
                        ...
                        <li>sistemul afiseaza un formular ce contine urmatoarele campuri de completat: email, parola,
                            confirmare parola
                        </li>
                        <li>pacientul completeaza formularul si apoi apasa butonul trimite</li>
                        <li>sistemul valideaza informatile trimise, le salveaza si trimite pe mail un cod de activare.
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>sistemul afiseaza un formular ce contine urmatoarele campuri de completat: email, cod
                            activare
                        </li>
                        <li>pacientul completeaza formularul si apoi apasa butonul trimite</li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>sistemul valideaza informatile trimise si apoi afiseaza functionalitatile la care are acces
                            utilizatorul conform rolurilor
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>sistemul afiseaza un formular ce contine urmatoarele campuri de completat: nume, prenume,
                            specialitate, medic, data programarii consultatiei, ora programarii consultatiei
                        </li>
                        <li>sistemul valideaza informatile trimise si trimite un email de confirmare a programarii
                            pentru consultatie
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>sistemul afiseaza un formular ce contine urmatoarele campuri de completat: nume, prenume,
                            analize, data programarii pentru recoltare, ora programarii pentru recoltare
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <ol>
                ...
                <li>Completare fise de consultatie
                    <ul>
                        ...
                        <li>sistemul afiseaza fisa de consultatie care are precompletat campurile numele si prenumele
                            pacientului
                        </li>
                        <li>fisa de consultatie contine urmatoarele campuri de comletat: diagnostic, analize
                            recomandate, tratament medicamentos recomandat, investigatii recomandate(ecografie
                            abdominala, mamografie, ...), alergii, boli cronice
                        </li>
                    </ul>
                </li>
                <li>Vizualizare rezultate analize ale unui pacient ce are programata o consultatie
                    <ul>
                        <li>utilizatorul trebuie sa fie autentificat in aplicatie cu rol de medic</li>
                        <li>sistemul afiseaza lista cu rezultate analize ale tuturor pacientilor ce au sau au avut
                            programare la medicul autentificat. un medic poate vedea doar rezultatele analizelor pentru
                            pacientii sai
                        </li>
                    </ul>
                </li>
